...
# Disable for this platform: `mulle-sourcetree mark MulleObjCExpatFoundation no-cmake-platform-darwin`
#
if( NOT MULLE_OBJC_EXPAT_FOUNDATION_LIBRARY)
   ...
   if( MULLE_OBJC_EXPAT_FOUNDATION_LIBRARY)
      ...
      #
      # Append header directory to user search path.
      # Disable with: `mulle-sourcetree mark MulleObjCExpatFoundation no-cmake-searchpath`
      #
      foreach( _TMP_MULLE_OBJC_EXPAT_FOUNDATION_NAME "MulleObjCExpatFoundation")
         set( _TMP_MULLE_OBJC_EXPAT_FOUNDATION_DIR "${_TMP_MULLE_OBJC_EXPAT_FOUNDATION_ROOT}/include/${_TMP_MULLE_OBJC_EXPAT_FOUNDATION_NAME}")
         if( IS_DIRECTORY "${_TMP_MULLE_OBJC_EXPAT_FOUNDATION_DIR}")
            set( INHERITED_INCLUDE_DIRS
               ${INHERITED_INCLUDE_DIRS}
               "${_TMP_MULLE_OBJC_EXPAT_FOUNDATION_DIR}"
               CACHE INTERNAL "need to cache this"
            )
            break()
         else()
...
if( NOT MULLE_OBJC_INET_OS_FOUNDATION_LIBRARY)
   ...
   if( MULLE_OBJC_INET_OS_FOUNDATION_LIBRARY)
      ...
      #
      # Append header directory to user search path.
      # Disable with: `mulle-sourcetree mark MulleObjCInetOSFoundation no-cmake-searchpath`
      #
      foreach( _TMP_MULLE_OBJC_INET_OS_FOUNDATION_NAME "MulleObjCInetOSFoundation")
         set( _TMP_MULLE_OBJC_INET_OS_FOUNDATION_DIR "${_TMP_MULLE_OBJC_INET_OS_FOUNDATION_ROOT}/include/${_TMP_MULLE_OBJC_INET_OS_FOUNDATION_NAME}")
         if( IS_DIRECTORY "${_TMP_MULLE_OBJC_INET_OS_FOUNDATION_DIR}")
            set( INHERITED_INCLUDE_DIRS
               ${INHERITED_INCLUDE_DIRS}
               "${_TMP_MULLE_OBJC_INET_OS_FOUNDATION_DIR}"
               CACHE INTERNAL "need to cache this"
            )
            break()
         else()
...
# Disable for this platform: `mulle-sourcetree mark mulle-objc-compat no-cmake-platform-darwin`
#
